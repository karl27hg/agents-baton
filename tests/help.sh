...
"$CLI" help cr list | grep 'active submitted-review claimant' >/dev/null
...
"$CLI" help cr show | grep -- '--include-related-handoffs' >/dev/null
"$CLI" help cr status | grep -- '--include-related-handoffs' >/dev/null
